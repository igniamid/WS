...
Workshop material is hosted at Gitlab <https://gitlab.com/muuankarski/tallinn_geodata_20230125/>. In the video below, I will show the process of logging into Posit.cloud, creating a project from a git repository and running the pre-workshop assignments.

### Pre-workshop assignment

Paste the content of these two code chunks to your R console
